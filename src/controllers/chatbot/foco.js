...
manager.addDocument('en', 'periodo turno manha tarde noite laboral pos-laboral', 'mostra.periodo');
manager.addDocument('en', 'horas', 'time');
manager.addDocument('en', 'abre inici', 'start');
manager.addDocument('en', 'Obrigado', 'thanks');

manager.addAnswer('en', 'mostra.cursos', 'A nossa instituição oferece o curso de Contabilidade, Gestão, GRH, Mecânica, Electricidade, Construção civil, Enfermagem e Educação de infância.');
